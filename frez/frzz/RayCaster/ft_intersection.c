...
/*   Updated: 2025/01/24 18:56:17 by bouhammo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	 git_first_x_intersection(t_start *var)
{
    ...
    inter.first_intersection_x = 0;
    inter.first_intersection_y = 0;
    inter.xa = 0;
    inter.ya = 0;
    inter.next_intersection_x = 0;
    inter.next_intersection_y = 0;
	...
	if(is_looking_up(var->ray->ray_angle))
		...
		inter.first_intersection_y = (floor(var->move->coor_y / TILE_SIZE) * TILE_SIZE ) + TILE_SIZE + 1;
